...
# (this is monodominance of one species with the total number of individuals given by 
# input size).
...
# First choose a random number according to a uniform distribution between 1 and x 
...
# Write a function "neutral_step(community)" to perform a single step of a simple 
# neutral model.
...
# Write a function "neutral_generation(community)" to simulate SEVERAL neutral steps 
# on a community for one generation.
# If the community consists of x individuals:
# x/2 individual neutral steps = complete generation
